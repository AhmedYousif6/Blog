  ...
  return (
    <div className='max-w-2xl mx-auto w-full p-3'>
        { currentUser ? (
            ...
            <div className='my-5 text-sm text-teal-500 flex gap-1'>
        ...
        {comments.length === 0 ? (
            <p className='text-sm my-5'>No comment's yet.</p>
        ) : (
            <>
          ...
          <Modal.Body>
            <div className='text-center'>
              <HiOutlineExclamationCircle
                className='text-gray-400 w-14 h-14 dark:text-gray-200 mb-4 mx-auto'
              />
              <h3
