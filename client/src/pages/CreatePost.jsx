...
export default function CreatePost() {
  ...
  return (
    <div className="p-3 max-w-3xl min-hscreen mx-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className='flex justify-between gap-4 items-center border-4
        ...
        <ReactQuill theme='snow' placeholder='Write something...'
           required className='h-72 mb-12' onChange={(value) => setFormData({ ...formData, content: value})}
        />
